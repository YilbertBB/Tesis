...
import 'FaceIDAnimationController.dart';
...
class FaceIDPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final facePaint = Paint()
      ...
      ..color = kprimaryColor.withOpacity(faceOpacity)
    ...
    final eyeBlinkPaint = Paint()
      ..strokeWidth = strokeWidth
      ..color =
          canBlink ? Colors.transparent : kprimaryColor.withOpacity(faceOpacity)
      ..strokeCap = StrokeCap.round;
    ...
    final check1 = Paint()
      ..strokeCap = StrokeCap.round
      ..color = canShowCheck1 ? kprimaryColor : Colors.transparent
      ..strokeWidth = strokeWidth;
    canvas.drawLine(
    ...
    final check2 = Paint()
      ..strokeCap = StrokeCap.round
      ..color = canShowCheck2 ? kprimaryColor : Colors.transparent
      ..strokeWidth = strokeWidth;
    canvas.drawLine(
      Offset(oneHalf, s * .7),
